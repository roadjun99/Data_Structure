...
file = open("C:/Users/sm222/OneDrive/바탕 화면/이것이 코딩테스트다 알고리즘 유형별 기출문제/Q1.py", "r")
fileData = file.read()
file.close()

file2 = open("C:/Users/sm222/OneDrive/바탕 화면/이것이 코딩테스트다 알고리즘 유형별 기출문제/Q2.py", "r")
...
checkBrackets(fileData2, len(fileData2))